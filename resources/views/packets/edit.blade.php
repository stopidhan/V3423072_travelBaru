                                ...
                                <form action="{{ route('packets.update', $packet->id) }}" method="POST"
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input type="text"
                                            ...
                                            name="nama_paket" value="{{ old('nama_paket', $packet->nama_paket) }}"
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Masukkan Deskripsi Paket">{{ old('deskripsi', $packet->deskripsi) }}</textarea>
                                        @error('deskripsi')
                                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                        <div>
                                            ...
                                            <input type="number"
                                                ...
                                                name="harga_total"
                                                value="{{ old('harga_total', $packet->harga_total) }}"
                                        ...
                                        <div>
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('total_pembelian', $packet->total_pembelian) }}"
                                            ...
                                            @for($i = 1; $i <= 5; $i++)
                                                <label class="inline-flex items-center">
                                                    <input type="radio"
                                                        ...
                                                        name="rating" value="{{ $i }}" @checked(old('rating', $packet->rating ?? null) == $i)>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                        <div>
                                            ...
                                            <input type="text"
                                                ...
                                                name="destinasi" value="{{ old('destinasi', $packet->destinasi) }}"
                                        ...
                                        <div>
                                            ...
                                            <input type="text"
                                                ...
                                                name="hotel" value="{{ old('hotel', $packet->hotel) }}"
                                        ...
                                        <div>
                                            ...
                                            <input type="text"
                                                ...
                                                name="transport" value="{{ old('transport', $packet->transport) }}"
                                    ...
                                    @php
                                        $existingLayanan = is_string($packet->layanan_tambahan)
                                            ? json_decode($packet->layanan_tambahan, true)
                                            : (is_array($packet->layanan_tambahan) ? $packet->layanan_tambahan : []);
                                    @endphp
                                            ...
                                            @foreach(['Pemandu Wisata', 'Makan 3x Sehari', 'Dokumentasi', 'Asuransi'] as $layanan)
                                                <label class="inline-flex items-center mr-6">
                                                    <input type="checkbox" name="layanan_tambahan[]" value="{{ $layanan }}"
                                                        @checked(in_array($layanan, old('layanan_tambahan', $existingLayanan ?? [])))
